...
- [x] LiftDashの目的と主要機能を確認できる
- [x] 必要なランタイム・外部サービスを確認できる
- [x] Supabaseプロジェクト、migration、認証、TOTP MFAの設定方法を確認できる
- [x] `.env.local`の作成から開発サーバー起動まで実行可能な手順を確認できる
- [x] 初回ログインとMFA登録の流れを確認できる
- [x] 種目、プリセット、トレーニング記録、履歴、ダッシュボードの使い方を確認できる
- [x] 型チェック、Lint、テスト、ビルド、セキュリティ監査のコマンドを確認できる
- [x] シークレット管理とAAL2/RLSの注意事項を確認できる
- [x] READMEの記載内容が現在のコード・設定と一致する
- [x] 対応する検証がすべてグリーン
